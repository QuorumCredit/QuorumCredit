//! Loan overwrite protection tests.
#![cfg(test)]
...
#[test]
fn test_loan_cannot_be_overwritten_while_active() {
    let env = Env::default();
    env.mock_all_auths();
